...
const Mainbody = () => {
  return (
    <div
      id="home"
      className="md:pt-0 lg:px-10 lg:pt-32 lg:pb-10 lg:w-full lg:items-center lg:justify-center flex lg:flex-col md:flex-col sm:flex-col"
    >
      <div className="flex flex-col gap-">
        ...
        >
          {title.map((i, key) => {
            return (
              <span className="text-white lg:leading-[200px]  lg:opacity-40 lg:hover:opacity-100 text-3xl  mt-[50px] lg:mt-0 lg:ml-0 lg:font-bold lg:text-[200px]">
                {i}
              </span>
            );
          })}
